...
export class SkillComponent implements OnInit {
  ...
  list(){
    this.api.post("skill/list", {}).subscribe((mydata:any)=>{
      this.skills = mydata.data;
  ...
  edit(id:string):void{
    this.id = id;
    this.api.post("skill/get", {id:this.id}).subscribe((mydata:any)=>{
        this.id = mydata.data._id;
        this.title = mydata.data.title;
        this.initialize();
      });
  ...
  delete(id:string):void{
    if(confirm("Sure to delete?")){
      let data = {id:id};
      this.api.post("skill/delete", {id}).subscribe((mydata)=>{
        this.list();
      });
    }
  }
  ...
  submit(formdata:any)
  {
    ...
    this.api.post("skill/save", formdata).subscribe((mydata)=>{
